	...
	<div class="col-md-12 col-xs-12">
		<div class="x_panel">
			<form class="form-horizontal form-label-left input_mask"
				method="post" action="shareAccountLedger.update">
					...
					<div class="form-group">
						...
						<div class="col-md-3 col-sm-3 col-xs-12">
							<input type="text" class="form-control" name="legacyAccountNo"
								placeholder="" value="${list.legacyAccountNo }">
						</div>
					...
					<div class="form-group">
						...
						<div class="col-md-3 col-sm-3 col-xs-12">
							<input type="text" class="form-control" placeholder=""
								name="accountNo" value="${ list.accountNo}">
						</div>
					...
					<div class="form-group" id="cashWithdraw">
						...
						<div class="col-md-3 col-sm-3 col-xs-12">
							<input type="text" class="form-control datenp"
								placeholder="" onblur="nepaliToEnglish('.datenp','.date')" value="${datenep }">
						</div>
						<label class="control-label col-md-2 col-sm-2 col-xs-12">Date(A.D.)
						</label>
						<div class="col-md-4 col-sm-4 col-xs-12">
							<input type="text" name="date" class="form-control date"
								placeholder="" value="${list.date }" onblur="englishToNepali('.datenp','.date')">
						</div>
					</div>
					<div class="ln_solid"></div>
