				...
				<div id="menu2" class="tab-pane fade in active">
					...
					<ul class="nav nav-tabs">
						<li><button type="submit" class="btn btn-success" form="form"
								name="addCustomerRelationOfficerDetail">Submit</button>&nbsp;&nbsp;&nbsp;</li>
					...
					<div class="tab-content">
						<div id="1" class="tab-pane fade in active">
							...
							<table class="table">
								<tr>
									<td><label for="relationshipOfficerName">Relationship
											Officer Name</label> <input class="form-control" type="text"
										name="relationshipOfficerName" /></td>

									<td><label for="address">Address</label> <input
										class="form-control" type="text" name="address" /></td>

									<td><label for="mobileNumber">Mobile Number </label> <input
										class="form-control" type="text" name="mobileNumber" /></td>
								</tr>
								...
								<tr>
									...
									<td><label for="office">Office</label> <input
										class="form-control" type="text" name="office" /></td>

									<td><label for="officePhnNum">Office Phone Number
									</label> <input class="form-control" type="text" name="officePhnNum" />
									</td>
								</tr>
