	...
	<div class="col-md-8 col-xs-12">
		<div class="x_panel">
			<form class="form-horizontal form-label-left input_mask"
				method="post" action="updatetel.add ">
					...
					<div class="form-group">
						...
						<div class="col-md-4 col-sm-4 col-xs-12">
							<select class="form-control" name="categoryid" id="categoryid">
								...
								<option value="${cat.categoryId }" <c:if test="${cat.categoryId eq tm.categoryId }">selected</c:if>>${tm.categoryId }</option>
								</c:forEach>
							</select>
							<%-- <input type="text" class="form-control" name="categoryid" id="categoryid"
								placeholder="" value="${tm.categoryHead }" > --%>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-md-4 col-sm-4 col-xs-12">
							<input type="text" class="form-control" name="accountName"
								placeholder="" value="${tm.accountName }" >
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-md-4 col-sm-4 col-xs-12">
							<input type="text" class="form-control" name="accountNumber"
								placeholder="" value="${tm.accountNumber }" >
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-md-4 col-sm-4 col-xs-12">
							<input type="text" class="form-control openDateNep" name="openDateN"
								placeholder=""  onblur="nepaliToEnglish('.openDateNep','.openDateen')"
								value="${tm.openDateN }">
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-md-4 col-sm-4 col-xs-12">
							<input type="text" class="form-control openDateen" name="openDate"
								placeholder=""  onblur="englishToNepali('.openDateNep','.openDateen')"
								value="${tm.openDate }">
						</div>
					</div>
