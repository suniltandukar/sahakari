	...
	<div class="col-md-12 col-sm-12 col-xs-12">
		...
		<div class="x_panel">
			<div class="x_title">
				...
				<a href="viewcustomer.click" class="btn btn-info btn-sm pull-right">Go Back</a>
								...
								<div role="tabpanel" class="tab-pane fade active in"
									...
									<table class="table">
										<tbody>
											<tr>
											<td><h5>Member Id</h5> 
											<input type="text" class="form-control" value="${cdetail.pid }"
