	...
	<div class="panel panel-default" style="width: 95%; margin: auto;">
		<div class="panel-heading">
			...
			<input type="submit" class="btn btn-info searchbtn"
				value="SEARCH">
				<button id="show" class="btn btn-primary pull-right">Create New User</button>
					
		</div>  
		
	</div>
	<div class="panel panel-default viewform" style="display: none; width: 95%; margin: auto;">
		<button id="hide" class="btn btn-danger pull-right">Cancel</button>
