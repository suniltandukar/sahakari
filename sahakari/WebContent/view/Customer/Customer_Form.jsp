			...
			<form class="form-horizontal" id="form1" method="post"
				...
				<ul class="nav nav-tabs">
					<li><button type="submit" class="btn btn-success" form="form1"
							name="customerForm">Submit</button>&nbsp;&nbsp;&nbsp;</li>
				...
				<div class="tab-content">
						...
						<table class="table">
							...
							<tr>
								...
								<td><label for="usrname">CUSTOMER LIABILITY</label> <input
									class="form-control" type="text" name="customerLiability" /></td>
							</tr>
							<tr>
					...
					<div id="2" class="tab-pane fade">
						<table class="table">
							...
							<tr>
								<td><label for="usrname">MARITAL STATUS</label> <select
							...
							<tr>
								...
								<td><label for="usrname">EMPLOYMENT STATUS</label> <input
									class="form-control" type="text" name="employmentStatus" /></td>
							</tr>
							<tr>
								...
								<td><label for="usrname">EMPLOYERS ADDRESS</label> <input
									class="form-control" type="text" name="employersAddress" /></td>
							</tr>
							<tr>
								...
								<td><label for="usrname">CUSTOMER CURRENCY</label> <input
									class="form-control" type="text" name="customerCurrency" /></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><label for="usrname">RESIDENCE STATUS</label> <select
									name="residenceStatus" class="form-control">
						...
						<table class="table">
							...
							<tr>
								...
								<td><label for="usrname">AUDIT DATE-TIME</label> <input
									class="form-control" type="datetime-local" name="auditDateCode" /></td>
								<td><label for="usrname">POSTING RESTRICT</label> <input
									class="form-control" type="text" name="postingRestrict" /></td>
							</tr>
							<tr>
							...
							<tr>
								<td><label for="residenceRegion">RESIDENCE REGION</label> <input
									class="form-control" type="text" name="residenceRegion" /></td>
							...
							<tr>
								<td><label for="customerRating">CUSTOMER RATING</label> <input
									class="form-control" type="text" name="customerRating" /></td>
							...
							<tr>
								...
								<td><label for="gender">GENDER</label> <select
					...
					<div id="5" class="tab-pane fade  ">
						<table class="table">
							<tr>
								...
								<td><label for="calcRiskClass">CALC RISK CLASS</label> <input
									class="form-control" type="text" name="calcRiskClass" /></td>
								<td><label for="manualRiskClass">MANUAL RISK CLASS</label>
									<input class="form-control" type="text" name="manualRiskClass" /></td>
							</tr>
							<tr>
								<td><label for="overrideReason">OVERRIDE REASON</label> <input
									class="form-control" type="text" name="overrideReason" /></td>
							...
							<tr>
								<td><label for="riskTolorence">RISK TOLERANCE </label> <input
									class="form-control" type="text" name="riskTolorence" /></td>
								<td><label for="riskFromDate">RISK FROM DATE</label> <input
									class="form-control" type="date" name="riskFromDate" /></td>
								<td><label for="lastKycReviewDate">LAST KYC REVIEW
										DATE</label> <input class="form-control" type="date"
									name="lastKycReviewDate" /></td>
							</tr>
							<tr>
								<td><label for="manualNextKycReviewDate">MANUAL
										NEXT KYC REVIEW DATE</label> <input class="form-control" type="date"
									name="manualNextKycReviewDate" /></td>
								<td><label for="autoNextSuitReviewDate">AUTO NEXT
										SUIT REVIEW DATE</label> <input class="form-control" type="date"
									name="autoNextSuitReviewDate" /></td>
								<td><label for="kycRelationship">KYC RELATIONSHIP</label> <input
									class="form-control" type="text" name="kycRelationship" /></td>
							</tr>
							<tr>
							...
							<tr>
								<td><label for="lastAlmResultDate">LAST ALM RESULT
										DATE</label> <input class="form-control" type="date"
								...
								<td><label for="interestBankingService">INTEREST
										BANKING SERVICE</label> <select class="form-control"
									name="interestBankingService">
					...
					<div id="6" class="tab-pane fade  ">
						<table class="table">
							<tr>
								<td><label for="temporaryAddress">Temporary Address</label>
									<input type="text" class="form-control"
									name="temporary_address"></td>
							</tr>
							<tr>
								<td><label for="tstate">STATE</label> <select name="tstate"
									class="form-control">
								...
								<td><label for="usrname">MUNICIPALITY/VILLAGE</label> <input
									class="form-control" type="text" name="tmunicipality_village" /></td>
							</tr>
							<tr>
								...
								<td><label for="usrname">STREET ADDRESS</label> <input
									class="form-control" type="text" name="tstreet_address" /></td>
							</tr>
						</table>
					</div>
					<div id="7" class="tab-pane fade  ">
						<table class="table">
							...
							<tr>
								<td><label for="pstate">STATE</label> <select name="pstate"
									class="form-control">
										<option value="state1">State 1</option>
										<option value="state2">State 2</option>
										<option value="state3">State 3</option>
								...
								<td><label for="usrname">MUNICIPALITY/VILLAGE</label> <input
									class="form-control" type="text" name="pmunicipality_village" /></td>
							</tr>
							<tr>
								<td><label for="usrname">WARD NUMBER</label> <input
								...
								<td><label for="usrname">STREET ADDRESS</label> <input
									class="form-control" type="text" name="pstreet_address" /></td>
							</tr>
						</table>
					</div>
				</div>
