	...
	<div class="panel panel-default " style="width: 95%; margin: auto;">
		...
		<div class="panel-body">
			<table id="example" class="display table table-striped table-bordered"
				...
				<tbody>
	<%int sno=1; %>
						<c:forEach items="${staff }" var="list">				
					<tr>
						<td><%=sno %></td>
						<td>${list.pid}</td>
						<td>${list.staffCode }</td>
						<td>${list.staffName }</td>
						<td>${list.staffAddress }</td>
						<td>${list.post }</td>
						...
						<td><div class="dropdown">
								...
								<ul class="dropdown-menu">
									<li><a href="editteller.click?id=${list.pid}" style="color: blue;"><i
											class="fa fa-eye" aria-hidden="true"></i> Show Detail</a></li>
									<li><a class="clickbtn" href="tellertransaction.del?id=${list.pid }"
